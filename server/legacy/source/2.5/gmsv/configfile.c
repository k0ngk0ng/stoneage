...
ReadConf readconf[]=
{
  ...
  { "appearpositionfile"  , config.appearfile,sizeof(config.appearfile),NULL,0},
    ...
    { "enable_nu_flow_control" ,NULL,0,
      (void*)&config.enable_nu_flow_control,INT},
...
int getNuFlowControl( void )
{
    return config.enable_nu_flow_control;
}
