...
int loadCharOne( char *id , int num, char *output , int outlen )
{
	 ...
	 * Preserve fgetc()'s int return type so EOF stays distinct from 255,
	 * and reject files that do not fit the caller's buffer.
	 */
